...
class ActivitiesTestCase(unittest.TestCase):
    ...
    def test_create_activity_happy_path(self):
        ...
        self.assertEqual(Users().users[0].user_bucket[0].activity_list[0], "Visit")
    ...
    def test_edit_activity_happy_path(self):
        ...
        self.assertEqual(Users().users[0].user_bucket[0].activity_list[0], "Buy Gifts")
    ...
    def test_edit_activity_sad_path_1(self):
        ...
        self.assertEqual(Users().users[0].user_bucket[0].activity_list[0], "Visit aunt")
