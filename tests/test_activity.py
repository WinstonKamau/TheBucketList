...
import unittest
#Importing the module models to access its global variable
...
class ActivitiesTestCase(unittest.TestCase):
    ...
    def test_create_activity_sad_path_1(self):
        '''Testing that the create activity does not create an activity that was created before'''
        models.users.clear()
        Users().create_user("user1", "user1@gmail.com", "password", "password")
        Users().login_user("user1@gmail.com", "password")
        BucketList().create_bucket("Family")
    ...
    def test_edit_activity_sad_path(self):
        '''Testing that edit activity does not edit the activity if the activity input is an empty string'''
        models.users.clear()
        Users().create_user("user1", "user1@gmail.com", "password", "password")
        Users().login_user("user1@gmail.com", "password")
        BucketList().create_bucket("Family")
    ...
    def test_edit_activity_sad_path_1(self):
        '''Testing that edit activity does not edit the activity if the activity input was already entered'''
        models.users.clear()
        Users().create_user("user1", "user1@gmail.com", "password", "password")
        Users().login_user("user1@gmail.com", "password")
        BucketList().create_bucket("Family")
